...
export class AgentService {
  ...
  removeConnection(connectionId: string): Observable<any> {
    ...
    return this.http
      .delete<any>(`/connections/${connectionId}`, { headers })
      .pipe(
        tap(() =>
  ...
  createInvitation(): Observable<any> {
    ...
    return this.http
      .post<any>("/out-of-band/create-invitation", invitationRequest)
      .pipe(
  ...
  receiveInvitation(invitation: any): Observable<any> {
    ...
    return this.http
      .post<any>("/out-of-band/receive-invitation", invitation, { headers })
      .pipe(
        tap((response) =>
          console.log("Receive invitation response:", response)
        ),
